...
即`0xff`= 15 * 16¹ + 15 * 16⁰ = 256-1

> 1字节 = 8 bit，8位二进制数字，相当于2位的16进制数字
>
> uint8.max = 256 = 0b1111,1111 = 0xff
...
> 怎么算的？
>
> 和十进制10^x 一样，二进制就是几位当2^x， 2^5 是32，这里已经超过32，所以但没有超过64（2^6 ），还缺8，而第四位2（2^3）代表的就是8
